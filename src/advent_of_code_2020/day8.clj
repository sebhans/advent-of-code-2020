...
(def operations
  "Operations manipulate a machine state, given an argument.
   The state consists of the instruction pointer and the accumulator."
  {:acc (fn [state arg] (-> state
                            (update :ip inc)
                            (update :acc #(+ % arg))))
