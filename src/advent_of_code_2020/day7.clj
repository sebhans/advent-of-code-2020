...
(def trial-input "light red bags contain 1 bright white bag, 2 muted yellow bags.
...
(def trial-input-2 "shiny gold bags contain 2 dark red bags.
...
(def real-input "shiny aqua bags contain 1 dark white bag.
